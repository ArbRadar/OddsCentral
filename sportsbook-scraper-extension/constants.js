...
export const LAYOUT_CONFIGS = {
  ...
  polymarket: {
    name: 'Polymarket',
    urlPatterns: ['polymarket.com'],
    selectors: {
      grid: {
        root: '[data-testid="market-list"], .market-card, .market-item',
        rows: '[data-testid="market-row"], .market-row, .market',
        cell: '.market-data, .outcome, .price'
      },
      columns: {
        startTime: '[data-testid="start-time"], .start-time, .event-time',
        teamName: '[data-testid="outcome-name"], .outcome-name, .market-title',
        bestPrice: '[data-testid="price"], .price, .odds',
        averagePrice: '.avg-price'
      },
      elements: {
        teamText: 'span, div, h3, p',
        oddsText: '.price, .odds',
        gameLink: 'a, [data-testid="market-link"]'
      }
    },
    features: {
